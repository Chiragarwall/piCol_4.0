...
document.getElementById('image-upload').addEventListener('change', function(event) {
    ...
    reader.onload = function() {
        ...
        img.onload = function() {
            clearImageWrapper();
            const existingCanvas = document.querySelector('#image-container canvas');
            if (existingCanvas) {
            ...
            document.getElementById('image-container').appendChild(uploadedImage);
            ...
            document.getElementById('image-container').appendChild(canvas); // Append canvas to image wrapper
